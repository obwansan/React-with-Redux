...
// The 'videos' prop(erty) in App is an object that is passed as an argument
// from App to VideoList (this happens when a prop is passed to a function
// component). The parameter the argument is passed into is (always)
